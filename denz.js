...
▒▒▒▒▒▒▒▒▒▒▒▐▒▒▒▒▌▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒SUBSCRIBE Hanbu FF
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒SUBSCRIBE Hanbu FF
SUBSCRIBE Hanbu FF SUBSCRIBE Hanbu FF SUBSCRIBE Hanbu FF SUBSCRIBE Hanbu FF SUBSC
*/
const
	{
...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Hanbu FF_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6282138919347-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© Hanbu FF_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Hanbu FF_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://youtube.com/channel/UCIvY2o-KctmlKWvXzqrXuWw`}}})
		}
		const simir = (teks) => {
		...
		const ovo = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://f.top4top.io/p_2100f7vs70.jpg"}}})
		}
		const dana = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://j.top4top.io/p_2100is9it0.jpg"}}})
		}
		const gopay = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://b.top4top.io/p_21003qgqr0.jpg"}}})
		}
...
sendButLocation(from, `🌹𝐇𝐄𝐋𝐋𝐎𝐖𝐎𝐑𝐋𝐃🌹\n\n_${NamaBot}_\n_Hay Kak ${pushname} 👋_\n\n「 𝑪𝑨𝑳𝑬𝑵𝑫𝑨𝑹 」\n\n*🐥 Day :* ${week}\n*🐥 Date :* ${calender}\n\n「 𝒀𝑶𝑼𝑹 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」\n\n*🐥 Username :* ${pushname}\n*🐥 Bio Info :*  ${stst}\n*🐥 Status :* ${isOwner ? 'Owner' : 'User'}\n*🐥 Nomor :* @${stod.split('@')[0]}\n*🐥 Info Nomor :* ${num.data.country_code} - ${num.data.carrier.type} - ${num.data.carrier.name}\n\n「 𝑩𝑶𝑻 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」\n\n*🐥 Nama Bot :* ${NamaBot}\n*🐥 Nama Owner :* ${NamaOwner}\n*🐥 Nomor Owner :* @${otod.split('@')[0]}`, "「 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔 」\n\n🔖 *OtherMenu*\n🔖 *OwnerMenu*\n🔖 *GroupMenu*\n🔖 *DownloadMenu*\n\n*_© Hanbu FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bm`,buttonText:{displayText:'📋'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'bm':
 listMsg = {
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `*❗ INFO*\n\nWaktu Buka Jam 09:00 - 22:00`, "*_© Hanbu FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gw1`,buttonText:{displayText:'👥 GRUB'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//sewa bot
case 'sewa':
        case '0':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*_© Hanbu FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'gc':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nSilahkan pilih ingin buka / tutup grub`, "*_© Hanbu FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}opengc`,buttonText:{displayText:'BUKA'},type:1},{buttonId:`${prefix}closegc`,buttonText:{displayText:'TUTUP'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'KLIK DISINI',
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE OVO",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://f.top4top.io/p_2100f7vs70.jpg"}}})
break
case 'qrg1':
denz.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE GOPAY",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://b.top4top.io/p_21003qgqr0.jpg"}}})
break
case 'qrg1':
denz.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE DANA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://j.top4top.io/p_2100is9it0.jpg"}}})
break
case 'o1':
menu = `*[❗] OPEN SEWA BOT*
╭───────────────
...
break
case 'qrcodedana':
denz.sendMessage(from,`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://j.top4top.io/p_2100is9it0.jpg"}}})
break
case 'qrcodegopay':
denz.sendMessage(from`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://b.top4top.io/p_21003qgqr0.jpg"}}})
break
//pppppp
case 'jadibot':
...
if (args.length < 1) return reply('Jumlahnya?')
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"message": `${NamaBot}`,
						"orderTitle": `${NamaOwner}`,
						"sellerJid": "6282138919347@s.whatsapp.net",
